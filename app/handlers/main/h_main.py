...
async def handle_main_command(message: types.Message, state: FSMContext):
    ...
    if message.text == MAIN_MENU["problems"]: 
        ...
        await message.answer(ASK_PROBLEM1, reply_markup=keyboard)
        await message.answer(ASK_PROBLEM2, reply_markup=keyboard)
        ...
        await message.answer(ASK_IDEA1, reply_markup=keyboard)
        await message.answer(ASK_IDEA2, reply_markup=keyboard)
        await MainOrder.waiting_for_input_info.set()
        ...
        await message.answer(ASK_QUESTION1, reply_markup=keyboard)
        await message.answer(ASK_QUESTION2, reply_markup=keyboard)
        await MainOrder.waiting_for_input_info.set()
